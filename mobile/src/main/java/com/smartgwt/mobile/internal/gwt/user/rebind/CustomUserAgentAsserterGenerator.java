...
package com.smartgwt.mobile.internal.gwt.user.rebind;
...
import com.google.gwt.user.client.CustomUserAgentAsserterDisabled;
import com.google.gwt.user.client.UserAgentAsserter;
 ...
 */
public class CustomUserAgentAsserterGenerator extends Generator {
  ...
  private static final String USER_AGENT_ASSERTER_DISABLED =
      CustomUserAgentAsserterDisabled.class.getCanonicalName();
