...
public class Indicators extends ScrollablePanel {
    ...
    public Indicators(String title,final NavStack nav) {
        super(title);
        final TableView tableView = new TableView();
        RecordList recordList = new RecordList();
        functions.add(new Function<Panel>(){public Panel execute(){return new ActivityIndicators(titles[0]);}});
        functions.add(new Function<Panel>(){public Panel execute(){return new ProgressIndicators(titles[1]);}});
