package com.smartgwt.mobile.client.i18n;
...
public interface SmartGwtMessages extends com.google.gwt.i18n.client.Messages {
  ...
  public SmartGwtMessages INSTANCE = GWT.create(SmartGwtMessages.class);
   ...
   */
  @DefaultMessage("Clear")
  @Key("dialog_ClearButtonTitle")
  String dialog_ClearButtonTitle();
   ...
   * 
   * @return translated "Load more records..."
   */
  @DefaultMessage("Load more records...")
  @Key("listGrid_loadMoreRecords")
  String listGrid_loadMoreRecords();
   ...
   * 
   * @return translated "equals (ignore case)"
   */
  @DefaultMessage("equals (ignore case)")
   ...
   * 
   * @return translated "not equal (ignore case)"
   */
