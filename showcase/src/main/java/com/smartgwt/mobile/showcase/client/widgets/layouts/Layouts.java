...
public class Layouts extends ScrollablePanel {
    ...
    public Layouts(String title, final NavStack nav) {
        super(title);
        final TableView tableView = new TableView();
        RecordList recordList = new RecordList();
        functions.add(new Function<Panel>(){public Panel execute(){return new VerticalLayouts(titles[0]);}});
        functions.add(new Function<Panel>(){public Panel execute(){return new HorizontalLayouts(titles[1]);}});
