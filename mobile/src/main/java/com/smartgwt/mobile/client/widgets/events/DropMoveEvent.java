...
public class DropMoveEvent extends GwtEvent<DropMoveHandler> implements Cancellable {
    private boolean cancel = false;

    /**
     * Handler type.
     */
    private static GwtEvent.Type<DropMoveHandler> TYPE;
    ...
    public static <S extends HasDropMoveHandlers & HasHandlers> void fire(
            S source) {
        if (TYPE != null) {
            DropMoveEvent event = new DropMoveEvent();
     ...
     */
    public static GwtEvent.Type<DropMoveHandler> getType() {
        if (TYPE == null) {
            TYPE = new GwtEvent.Type<DropMoveHandler>();
        }
        return TYPE;
    }
